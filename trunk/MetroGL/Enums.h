...
namespace MetroGL
{
	...
	public enum class AlphaFunction : int
    {
        Never = ((int)0x0200),
        Less = ((int)0x0201),
        Equal = ((int)0x0202),
    ...
    public enum class Amdcompressed3Dctexture : int
    {
        GL_3DcXAmd = ((int)0x87F9),
        GL_3DcXyAmd = ((int)0x87FA),
        AmdCompressed3DcTexture = ((int)1),
    ...
    public enum class AmdcompressedAtctexture : int
    {
        AtcRgbaInterpolatedAlphaAmd = ((int)0x87EE),
        AtcRgbAmd = ((int)0x8C92),
        AtcRgbaExplicitAlphaAmd = ((int)0x8C93),
    ...
    public enum class BeginMode : int
    {
        Points = ((int)0x0000),
        Lines = ((int)0x0001),
        LineLoop = ((int)0x0002),
    ...
    public enum class BlendingFactorDest : int
    {
        Zero = ((int)0),
        SrcColor = ((int)0x0300),
        OneMinusSrcColor = ((int)0x0301),
    ...
    public enum class BlendingFactorSrc : int
    {
        DstColor = ((int)0x0306),
        OneMinusDstColor = ((int)0x0307),
        SrcAlphaSaturate = ((int)0x0308),
    ...
    public enum class Boolean : int
    {
        False = ((int)0),
        True = ((int)1),
    };

    public enum class BufferObjects : int
    {
        BufferSize = ((int)0x8764),
        BufferUsage = ((int)0x8765),
        ArrayBuffer = ((int)0x8892),
    ...
    public enum class ClearBufferMask : int
    {
        DepthBufferBit = ((int)0x00000100),
        StencilBufferBit = ((int)0x00000400),
        ColorBufferBit = ((int)0x00004000),
    ...
    public enum class ClipPlaneName : int
    {
        ClipPlane0 = ((int)0x3000),
        ClipPlane1 = ((int)0x3001),
        ClipPlane2 = ((int)0x3002),
    ...
    public enum class CullFaceMode : int
    {
        Front = ((int)0x0404),
        Back = ((int)0x0405),
        FrontAndBack = ((int)0x0408),
    ...
    public enum class DataType : int
    {
        Byte = ((int)0x1400),
        UnsignedByte = ((int)0x1401),
        Short = ((int)0x1402),
    ...
    public enum class EnableCap : int
    {
        PointSmooth = ((int)0x0B10),
        LineSmooth = ((int)0x0B20),
        CullFace = ((int)0x0B44),
    ...
    public enum class ExttextureFilterAnisotropic : int
    {
        TextureMaxAnisotropyExt = ((int)0x84FE),
        MaxTextureMaxAnisotropyExt = ((int)0x84FF),
        ExtTextureFilterAnisotropic = ((int)1),
    ...
    public enum class ExttextureFormatBgra8888 : int
    {
        Bgra = ((int)0x80E1),
        ExtTextureFormatBgra8888 = ((int)1),
    };

    public enum class FogMode : int
    {
        Exp = ((int)0x0800),
        Exp2 = ((int)0x0801),
    };

    public enum class FogParameter : int
    {
        FogDensity = ((int)0x0B62),
        FogStart = ((int)0x0B63),
        FogEnd = ((int)0x0B64),
    ...
    public enum class FrontFaceDirection : int
    {
        Cw = ((int)0x0900),
        Ccw = ((int)0x0901),
    };

    public enum class GetPName : int
    {
        CurrentColor = ((int)0x0B00),
        CurrentNormal = ((int)0x0B02),
        CurrentTextureCoords = ((int)0x0B03),
    ...
    public enum class GetTextureParameter : int
    {
        NumCompressedTextureFormats = ((int)0x86A2),
        CompressedTextureFormats = ((int)0x86A3),
    };

    public enum class HintMode : int
    {
        DontCare = ((int)0x1100),
        Fastest = ((int)0x1101),
        Nicest = ((int)0x1102),
    ...
    public enum class HintTarget : int
    {
        PerspectiveCorrectionHint = ((int)0x0C50),
        PointSmoothHint = ((int)0x0C51),
        LineSmoothHint = ((int)0x0C52),
    ...
    public enum class ImgreadFormat : int
    {
        Bgra = ((int)0x80E1),
        UnsignedShort4444Rev = ((int)0x8365),
        UnsignedShort1555Rev = ((int)0x8366),
    ...
    public enum class ImgtextureCompressionPvrtc : int
    {
        CompressedRgbPvrtc4Bppv1Img = ((int)0x8C00),
        CompressedRgbPvrtc2Bppv1Img = ((int)0x8C01),
        CompressedRgbaPvrtc4Bppv1Img = ((int)0x8C02),
    ...
    public enum class ImgtextureEnvEnhancedFixedFunction : int
    {
        Dot3RgbaImg = ((int)0x86AF),
        ModulateColorImg = ((int)0x8C04),
        RecipAddSignedAlphaImg = ((int)0x8C05),
    ...
    public enum class ImguserClipPlane : int
    {
        MaxClipPlanesImg = ((int)0x0D32),
        ClipPlane0Img = ((int)0x3000),
        ClipPlane1Img = ((int)0x3001),
    ...
    public enum class LightModelParameter : int
    {
        LightModelTwoSide = ((int)0x0B52),
        LightModelAmbient = ((int)0x0B53),
    };

    public enum class LightName : int
    {
        Light0 = ((int)0x4000),
        Light1 = ((int)0x4001),
        Light2 = ((int)0x4002),
    ...
    public enum class LightParameter : int
    {
        Ambient = ((int)0x1200),
        Diffuse = ((int)0x1201),
        Specular = ((int)0x1202),
    ...
    public enum class MaterialParameter : int
    {
        Emission = ((int)0x1600),
        Shininess = ((int)0x1601),
        AmbientAndDiffuse = ((int)0x1602),
    ...
    public enum class MatrixMode : int
    {
        Modelview = ((int)0x1700),
        Projection = ((int)0x1701),
        Texture = ((int)0x1702),
    ...
    public enum class OesblendEquationSeparate : int
    {
        BlendEquationRgbOes = ((int)0x8009),
        BlendEquationAlphaOes = ((int)0x883D),
        OesBlendEquationSeparate = ((int)1),
    ...
    public enum class OesblendFuncSeparate : int
    {
        BlendDstRgbOes = ((int)0x80C8),
        BlendSrcRgbOes = ((int)0x80C9),
        BlendDstAlphaOes = ((int)0x80CA),
    ...
    public enum class OesblendSubtract : int
    {
        FuncAddOes = ((int)0x8006),
        BlendEquationOes = ((int)0x8009),
        FuncSubtractOes = ((int)0x800A),
    ...
    public enum class OesbyteCoordinates : int
    {
        OesByteCoordinates = ((int)1),
    };

    public enum class OescompressedEtc1Rgb8Texture : int
    {
        Etc1Rgb8Oes = ((int)0x8D64),
        OesCompressedEtc1Rgb8Texture = ((int)1),
    };

    public enum class OescompressedPalettedTexture : int
    {
        Palette4Rgb8Oes = ((int)0x8B90),
        Palette4Rgba8Oes = ((int)0x8B91),
        Palette4R5G6B5Oes = ((int)0x8B92),
    ...
    public enum class Oesdepth24 : int
    {
        DepthComponent24Oes = ((int)0x81A6),
        OesDepth24 = ((int)1),
    };

    public enum class Oesdepth32 : int
    {
        DepthComponent32Oes = ((int)0x81A7),
        OesDepth32 = ((int)1),
    };

    public enum class OesdrawTexture : int
    {
        TextureCropRectOes = ((int)0x8B9D),
        OesDrawTexture = ((int)1),
    };

    public enum class Oeseglimage : int
    {
        OesEglImage = ((int)1),
    };

    public enum class OeselementIndexUint : int
    {
        OesElementIndexUint = ((int)1),
    };

    public enum class OesextendedMatrixPalette : int
    {
        OesExtendedMatrixPalette = ((int)1),
    };

    public enum class OesfboRenderMipmap : int
    {
        OesFboRenderMipmap = ((int)1),
    };

    public enum class OesfixedPoint : int
    {
        FixedOes = ((int)0x140C),
        OesFixedPoint = ((int)1),
    };

    public enum class OesframebufferObject : int
    {
        NoneOes = ((int)0),
        InvalidFramebufferOperationOes = ((int)0x0506),
        Rgba4Oes = ((int)0x8056),
    ...
    public enum class Oesmapbuffer : int
    {
        WriteOnlyOes = ((int)0x88B9),
        BufferAccessOes = ((int)0x88BB),
        BufferMappedOes = ((int)0x88BC),
    ...
    public enum class OesmatrixGet : int
    {
        ModelviewMatrixFloatAsIntBitsOes = ((int)0x898D),
        ProjectionMatrixFloatAsIntBitsOes = ((int)0x898E),
        TextureMatrixFloatAsIntBitsOes = ((int)0x898F),
    ...
    public enum class OesmatrixPalette : int
    {
        MaxVertexUnitsOes = ((int)0x86A4),
        WeightArrayTypeOes = ((int)0x86A9),
        WeightArrayStrideOes = ((int)0x86AA),
    ...
    public enum class OespackedDepthStencil : int
    {
        DepthStencilOes = ((int)0x84F9),
        UnsignedInt248Oes = ((int)0x84FA),
        Depth24Stencil8Oes = ((int)0x88F0),
    ...
    public enum class OespointSizeArray : int
    {
        PointSizeArrayTypeOes = ((int)0x898A),
        PointSizeArrayStrideOes = ((int)0x898B),
        PointSizeArrayPointerOes = ((int)0x898C),
    ...
    public enum class OespointSprite : int
    {
        PointSpriteOes = ((int)0x8861),
        CoordReplaceOes = ((int)0x8862),
        OesPointSprite = ((int)1)
    ...
    public enum class OesqueryMatrix : int
    {
        OesQueryMatrix = ((int)1)
    };

    public enum class OesreadFormat : int
    {
        ImplementationColorReadTypeOes = ((int)0x8B9A),
        ImplementationColorReadFormatOes = ((int)0x8B9B),
        OesReadFormat = ((int)1)
    ...
    public enum class Oesrgb8Rgba8 : int
    {
        Rgb8Oes = ((int)0x8051),
        Rgba8Oes = ((int)0x8058),
        OesRgb8Rgba8 = ((int)1)
    ...
    public enum class OessinglePrecision : int
    {
        OesSinglePrecision = ((int)1)
    };

    public enum class Oesstencil1 : int
    {
        StencilIndex1Oes = ((int)0x8D46),
        OesStencil1 = ((int)1)
    };

    public enum class Oesstencil4 : int
    {
        StencilIndex4Oes = ((int)0x8D47),
        OesStencil4 = ((int)1)
    };

    public enum class Oesstencil8 : int
    {
        StencilIndex8Oes = ((int)0x8D48),
        OesStencil8 = ((int)1)
    };

    public enum class OesstencilWrap : int
    {
        IncrWrapOes = ((int)0x8507),
        DecrWrapOes = ((int)0x8508),
        OesStencilWrap = ((int)1),
    ...
    public enum class OestextureCubeMap : int
    {
        TextureGenModeOes = ((int)0x2500),
        NormalMapOes = ((int)0x8511),
        ReflectionMapOes = ((int)0x8512),
    ...
    public enum class OestextureEnvCrossbar : int
    {
        OesTextureEnvCrossbar = ((int)1)
    };

    public enum class OestextureMirroredRepeat : int
    {
        MirroredRepeatOes = ((int)0x8370),
        OesTextureMirroredRepeat = ((int)1)
    };

    public enum class OpenGlescoreVersions : int
    {
        VersionEsCl10 = ((int)1),
        VersionEsCl11 = ((int)1),
        VersionEsCm10 = ((int)1),
    ...
    public enum class PixelStoreParameter : int
    {
        UnpackAlignment = ((int)0x0CF5),
        PackAlignment = ((int)0x0D05)
    };
    ...
    public enum class QcomdriverControl : int
    {
        QcomDriverControl = ((int)1)
    };

    public enum class QcomperfmonGlobalMode : int
    {
        PerfmonGlobalModeQcom = ((int)0x8FA0),
        QcomPerfmonGlobalMode = ((int)1)
    };

    public enum class ShadingModel : int
    {
        Flat = ((int)0x1D00),
        Smooth = ((int)0x1D01),
    };

    public enum class StencilOp : int
    {
        Keep = ((int)0x1E00),
        Replace = ((int)0x1E01),
        Incr = ((int)0x1E02),
    ...
    public enum class StringName : int
    {
        Vendor = ((int)0x1F00),
        Renderer = ((int)0x1F01),
        Version = ((int)0x1F02),
    ...
    public enum class TextureCombineDot3 : int
    {
        AlphaScale = ((int)0x0D1C),
        Subtract = ((int)0x84E7),
        Combine = ((int)0x8570),
    ...
    public enum class TextureEnvMode : int
    {
        Add = ((int)0x0104),
        Modulate = ((int)0x2100),
        Decal = ((int)0x2101)
    ...
    public enum class TextureEnvParameter : int
    {
        TextureEnvMode = ((int)0x2200),
        TextureEnvColor = ((int)0x2201),
    };

    public enum class TextureEnvTarget : int
    {
        TextureEnv = ((int)0x2300)
    };

    public enum class TextureMagFilter : int
    {
        Nearest = ((int)0x2600),
        Linear = ((int)0x2601)
    };

    public enum class TextureMinFilter : int
    {
        NearestMipmapNearest = ((int)0x2700),
        LinearMipmapNearest = ((int)0x2701),
        NearestMipmapLinear = ((int)0x2702),
    ...
    public enum class TextureParameterName : int
    {
        TextureMagFilter = ((int)0x2800),
        TextureMinFilter = ((int)0x2801),
        TextureWrapS = ((int)0x2802),
    ...
    public enum class TextureUnit : int
    {
        Texture0 = ((int)0x84C0),
        Texture1 = ((int)0x84C1),
        Texture2 = ((int)0x84C2),
    ...
    public enum class TextureWrapMode : int
    {
        Repeat = ((int)0x2901),
        ClampToEdge = ((int)0x812F)
    };
